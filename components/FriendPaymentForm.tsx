...
import { Calendar, Tag, CreditCard, FileText, Users, X } from 'lucide-react-native';
import { FormField } from './FormField';
import { DropdownSelector } from './DropdownSelector';

interface FriendPaymentFormProps {
  onClose: () => void;
}

export function FriendPaymentForm({ onClose }: FriendPaymentFormProps) {
  ...
  const paymentTypes = ['I paid for them', 'They paid for me'];

  const handleSubmit = () => {
    console.log({ amount, friend, category, paymentMode, date, description, paymentType });
    onClose();
  };
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={styles.title}>Add Friend Payment</Text>
      ...
      <ScrollView style={styles.form} showsVerticalScrollIndicator={false}>
        ...
        <DropdownSelector
          ...
          icon={<Users size={20} color="#9CA3AF" />}
        />
